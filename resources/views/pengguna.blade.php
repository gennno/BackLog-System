                ...
                <div id="formTemuan" class="bg-white rounded-xl shadow p-6 hidden">
                    ...
                    <form class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="username" class="w-full border rounded-md p-2 mt-1"
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" class="w-full border rounded-md p-2 mt-1"
                        ...
                        <div>
                            ...
                            <select name="role" class="w-full border rounded-md p-2 mt-1" required>
                                ...
                                <option value="Karyawan Site">Karyawan Site</option>
                        ...
                        <table class="table-auto w-full text-sm text-left border border-gray-300">
                            ...
                            <tbody class="text-gray-800">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-2 border whitespace-nowrap">U-001</td>
                                    <td class="px-4 py-2 border whitespace-nowrap">
                                        <img src="/img/engine.jpg" alt="Foto Profil"
                                            class="w-14 h-14 object-cover rounded-full">
                                    </td>
                                    <td class="px-4 py-2 border whitespace-nowrap">zulkifli@example.com</td>
                                    <td class="px-4 py-2 border whitespace-nowrap">Zulkifli</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-2 border whitespace-nowrap">U-002</td>
                                    <td class="px-4 py-2 border whitespace-nowrap">
                                        <img src="/img/engine.jpg" alt="Foto Profil"
                                            class="w-14 h-14 object-cover rounded-full">
                                    </td>
                                    <td class="px-4 py-2 border whitespace-nowrap">ahmad@example.com</td>
                                    <td class="px-4 py-2 border whitespace-nowrap">Ahmad Zainal</td>
                                    <td class="px-4 py-2 border">
                                        <span
                                            class="inline-block px-2 py-1 text-xs font-semibold text-black bg-yellow-400 rounded-full">
                                            Karyawan Site
                                        </span>
                                    </td>
                                    <td class="px-4 py-2 border text-center whitespace-nowrap">
