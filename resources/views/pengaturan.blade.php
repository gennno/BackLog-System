        ...
        <div class="flex-1 flex flex-col w-screen overflow-auto">
            ...
            <main class="p-4 sm:p-6 flex-1 w-full max-w-3xl mx-auto space-y-6">
                <form action="{{ route('pengaturan.update') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6 bg-white p-6 rounded-xl border border-gray-200 shadow">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') ?? auth()->user()->name }}"
                            class="w-full border rounded-md p-2" placeholder="Masukkan nama lengkap" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') ?? auth()->user()->email }}"
                            class="w-full border rounded-md p-2" placeholder="Masukkan email aktif" required>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Minimal 6 karakter. Biarkan kosong jika tidak ingin mengubah.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="w-full border rounded-md p-2"
