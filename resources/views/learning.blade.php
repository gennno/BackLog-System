        ...
        <div class="flex-1 flex flex-col w-screen overflow-auto">
            ...
            <main class="p-4 sm:p-6 flex-1 w-full space-y-6">
                <div id="learningContainer" class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-6">
                    ...
                    <a href="https://drive.google.com/drive/folders/1Z2yLL3VsgLIuM88WInrhITsT9KjC5HPS?usp=drive_link"
                        target="_blank"
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Manual pelatihan dan panduan teknis untuk wheel loader dan
                                dozer.</p>
                        </div>
                    </a>

                    <!-- Engine Group -->
                    <a href="https://drive.google.com/drive/folders/1KtSIGJzeVmJP2SSoTgu32fz0zxdHPPZc?usp=drive_link"
                        target="_blank"
                        class="block bg-white rounded-xl shadow hover:shadow-lg transition duration-300 overflow-hidden border border-gray-200">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Dokumentasi dan pembelajaran mengenai sistem mesin unit
                                berat.</p>
                        </div>
                    </a>

                    <!-- Dump Truck Group -->
                    <a href="https://drive.google.com/drive/folders/1BtzIuIkmUAZKYAWtNfzcoaWiwyIU6yoW?usp=drive_link"
                        target="_blank"
                        class="block bg-white rounded-xl shadow hover:shadow-lg transition duration-300 overflow-hidden border border-gray-200">
                    ...
                    <!-- Motor Grader Group -->
                    <a href="https://drive.google.com/drive/folders/1JpjX62_a3IehrAWNJZ4QkifIboORuQ0w?usp=drive_link"
                        target="_blank"
                        class="block bg-white rounded-xl shadow hover:shadow-lg transition duration-300 overflow-hidden border border-gray-200">
